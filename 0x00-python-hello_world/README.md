...
1-run_inline: writes a Shell script that runs python code
2-print.py:writes a Python script that prints exactly "Programming is like building a multilingual puzzle, followed by a new line.
